# ASWARTH NARAYANA A PROGRAMMING ENTHUSIAST
## THE TASKS I COMPLETED
### TASK-1 (DID EARLIER)
   *I succesfully completed this task as we only had to write the given code in the console window of the webpage and it succesfully
    ran and the output was "It's all done".*
### TASK-2 (DID EARLIER)
   *I completed this task and was able to finish most of the programs as I had studied C and C++ in my 11th and 12th so I 
   completed this task comfortably.*
...
### TASK-7 (DID NOT DO EARLIER)
   *I managed to do this task with the help of online websites and using the Regex. I also felt happy to see the correct output.
    ...
    *[View code]*(https://github.com/aswarth123/amfoss-tasks/blob/master/TASK-7)
...
### TASK-3,TASK-4,TASK-5,TASK-6
   *These tasks I could not complete due to lack of time, bombardment of asiignments, lab tests and their viva's. These are the 
   tasks which I felt that they would require time and proper understanding before doing them. So I decided to complete the other
...
## AFTER JOINING FOSS
   *Explored about new programming languages and learned how to write a code for them. Before this I had only heard the names of
